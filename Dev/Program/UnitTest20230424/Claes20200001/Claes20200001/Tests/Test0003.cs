	...
	public class Test0003
	{
		public void Test01()
		{
			for (int testcnt = 0; testcnt < 1000; testcnt++)
			{
				...
				bool[] table = SCommon.GenerateLimit(SCommon.CRandom.GetRange(1, 300), () => SCommon.CRandom.GetBoolean()).ToArray();
		...
		public void Test02()
		{
			for (int testcnt = 0; testcnt < 10000; testcnt++)
			{
				...
				uint[] table = SCommon.GenerateLimit(SCommon.CRandom.GetRange(1, 1000), () => SCommon.CRandom.GetUInt()).ToArray();
		...
		public void Test03()
		{
			for (int testcnt = 0; testcnt < 10000; testcnt++)
			{
				...
				ulong[] table = SCommon.GenerateLimit(SCommon.CRandom.GetRange(1, 1000), () => SCommon.CRandom.GetULong()).ToArray();
